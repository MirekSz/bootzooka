    ...
    var DiagramBuilder = A.Component.create({
        ...
        prototype: {
            ...
            showSuggestConnectorOverlay: function (xy) {
                ...
                if (showSuggestConnectorOverlay.bodyNode) {
                    $(showSuggestConnectorOverlay.bodyNode._node).find('li').removeClass('hidden');
                }
            ...
            _onDeleteKey: function (event) {
                if (!$(event.target._node).is('input')) {
                    var instance = this,
            ...
            _onDropHit: function (event) {
                ...
                if (instance.isAvailableFieldsDrag(drag)) {
                    this.showNewFieldOptions(instance, drag);
                }
            },
            ...
            _onSuggestConnectorNodeClick: function (event) {
                ...
                var diagramArgs = {
                    ...
                    callback: function (node) {
                        instance.publishedTarget = node;

                        instance.suggestFlow = true;
                ...
                instance.hideSuggestConnectorOverlay(diagramArgs);
            },
